...
public class FormatValueStatement extends ValueStatement {
    private final ValueStatement format;
    private final ValueStatement object;

    public FormatValueStatement(ValueStatement format) {
        this(format, null);
    }

    public FormatValueStatement(ValueStatement format, ValueStatement object) {
        this.format = format;
        this.object = object;
    }
