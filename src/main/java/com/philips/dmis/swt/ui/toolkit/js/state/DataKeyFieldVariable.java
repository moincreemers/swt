...
public class DataKeyFieldVariable implements JsVariable {
    public static final String ID = "dataKeyField";
    private final Widget widget;
    private final WidgetType widgetType;

    public DataKeyFieldVariable(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        String dataKeyField = hasDataTemplate.getDataKeyField();
        if (dataKeyField == null || dataKeyField.isEmpty()) {
            js.append("null");
        } else {
            js.append("'%s'", dataKeyField);
        }
    }
}
