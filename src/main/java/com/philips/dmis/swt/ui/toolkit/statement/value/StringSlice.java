...
public class StringSlice extends ValueStatement {
    private final ValueStatement string;
    private final ValueStatement start;
    private final ValueStatement end;

    public StringSlice(ValueStatement string, ValueStatement start) {
        this(string, start, null);
    }

    public StringSlice(ValueStatement string, ValueStatement start, ValueStatement end) {
        this.string = string;
        this.start = start;
        this.end = end;
    }
