...
public class CodePointAtValueStatement extends ValueStatement {
    private final ValueStatement value;
    private final ValueStatement index;

    public CodePointAtValueStatement(ValueStatement value, ValueStatement index) {
        this.value = value;
        this.index = index;
    }
