...
@Description("Creates a new array using a map function on each element of the array")
public class ArrayMapValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final MethodStatement function;

    public ArrayMapValueStatement(ValueStatement array, MethodStatement function) {
        this.array = array;
