...
@Description("Returns a relative URL to open a Page")
public class GetPageValueStatement extends ValueStatement {
    private final Class<? extends Page> pageClass;
    private final ValueStatement valueStatement;

    public GetPageValueStatement(Class<? extends Page> pageClass) {
        this(pageClass, null);
    }

    public GetPageValueStatement(Class<? extends Page> pageClass, ValueStatement valueStatement) {
