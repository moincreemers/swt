...
public class NumberingLevelVariable implements JsVariable, IsPageModuleMember {
    public static final String ID = "numberingLevel";
    private final Widget widget;
    private final WidgetType widgetType;

    public NumberingLevelVariable(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        if (widget instanceof HasNumberedText) {
            ...
            js.append("%d", hasNumberedText.getLevel());
        } else {
            js.append("0");
        }
    }
