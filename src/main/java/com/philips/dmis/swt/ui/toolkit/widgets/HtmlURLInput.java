...
public class HtmlURLInput extends ValueWidget<HtmlURLInput> implements
    ...
    private final KeyInputImpl<HtmlURLInput> keyInputImpl = new KeyInputImpl<>(this);

    @Override
    public HasKeyInput<HtmlURLInput> getKeyInputImpl() {
        return keyInputImpl;
    }

    @Override
    public HtmlURLInput onInput(InputEventHandler eventHandler) {
        return keyInputImpl.onInput(eventHandler);
    }

    @Override
    public HtmlURLInput onKeyDown(KeyDownEventHandler eventHandler) {
        return keyInputImpl.onKeyDown(eventHandler);
    }

    @Override
    public HtmlURLInput onKeyPress(KeyPressEventHandler eventHandler) {
        return keyInputImpl.onKeyPress(eventHandler);
    }

    @Override
    public HtmlURLInput onKeyUp(KeyUpEventHandler eventHandler) {
