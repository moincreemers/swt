...
public class StringSubstringValueStatement extends ValueStatement {
    private final ValueStatement string;
    private final ValueStatement start;
    private final ValueStatement end;

    public StringSubstringValueStatement(ValueStatement string, ValueStatement start) {
        this(string, start, null);
    }

    public StringSubstringValueStatement(ValueStatement string, ValueStatement start, ValueStatement end) {
        this.string = string;
        this.start = start;
        this.end = end;
    }
