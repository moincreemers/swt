...
public class CharCodeAtValueStatement extends ValueStatement {
    private final ValueStatement value;
    private final ValueStatement index;

    public CharCodeAtValueStatement(ValueStatement value, ValueStatement index) {
        this.value = value;
        this.index = index;
    }
