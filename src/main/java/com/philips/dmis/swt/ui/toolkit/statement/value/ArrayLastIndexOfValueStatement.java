...
@Description("Returns the last occurrence of the specified value or -1")
public class ArrayLastIndexOfValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final ValueStatement value;

    public ArrayLastIndexOfValueStatement(ValueStatement array, ValueStatement value) {
        this.array = array;
        this.value = value;
    }
