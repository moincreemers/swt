...
public class ObjectPropertyValueStatement extends ValueStatement {
    private final ValueStatement object;
    private final ValueStatement memberNameOrPath;

    public ObjectPropertyValueStatement(ValueStatement object, ValueStatement memberNameOrPath) {
        this.object = object;
