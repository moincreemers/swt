...
public class StringReplaceAllValueStatement extends ValueStatement {
    private final ValueStatement string;
    private final ValueStatement search;
    private final ValueStatement value;

    public StringReplaceAllValueStatement(ValueStatement string, ValueStatement search, ValueStatement value) {
        this.string = string;
        this.search = search;
        this.value = value;
    }
