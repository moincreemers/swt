...
public class HtmlMonthInput extends ValueWidget<HtmlMonthInput,ValueDataSourceUsage> implements
    ...
    private final KeyInputImpl<HtmlMonthInput> keyInputImpl = new KeyInputImpl<>(this);

    @Override
    public HasKeyInput<HtmlMonthInput> getKeyInputImpl() {
        return keyInputImpl;
    }

    @Override
    public HtmlMonthInput onInput(InputEventHandler eventHandler) {
        return keyInputImpl.onInput(eventHandler);
    }

    @Override
    public HtmlMonthInput onKeyDown(KeyDownEventHandler eventHandler) {
        return keyInputImpl.onKeyDown(eventHandler);
    }

    @Override
    public HtmlMonthInput onKeyPress(KeyPressEventHandler eventHandler) {
        return keyInputImpl.onKeyPress(eventHandler);
    }

    @Override
    public HtmlMonthInput onKeyUp(KeyUpEventHandler eventHandler) {
