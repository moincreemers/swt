...
@Description("Returns a new array which is the specified array filtered using the specified predicate")
public class ArrayFilterValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final PredicateStatement predicate;

    public ArrayFilterValueStatement(ValueStatement array, PredicateStatement predicate) {
        this.array = array;
