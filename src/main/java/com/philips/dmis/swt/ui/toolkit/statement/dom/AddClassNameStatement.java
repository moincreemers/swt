...
public class AddClassNameStatement extends DOMStatement {
    private final DOMSelectorStatement nodes;
    private final ValueStatement className;

    public AddClassNameStatement(DOMSelectorStatement nodes, ValueStatement className) {
        this.nodes = nodes;
    ...
    public void renderJs(Toolkit toolkit, Widget widget, JsWriter js) throws JsRenderException {
        ...
        js.append(".forEach(");
        js.append("(e)=>{");
        js.append("e.classList.add(%s);", ValueStatement.valueOf(toolkit, className, widget));
        js.append("}");
        js.append(");");
    }
