...
@Description("Finds the first occurrence of a value using the specified predicate and returns the index or -1")
public class ArrayFindIndexValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final PredicateStatement predicate;

    public ArrayFindIndexValueStatement(ValueStatement array, PredicateStatement predicate) {
        this.array = array;
