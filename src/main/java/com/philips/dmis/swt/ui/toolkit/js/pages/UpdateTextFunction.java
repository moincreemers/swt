...
public class UpdateTextFunction implements JsFunction, IsPageModuleMember {
    public static final String ID = "updateText";
    private final Widget widget;
    private final WidgetType widgetType;

    public UpdateTextFunction(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("%s(object);", JsPagesModule.getId(widget, SetTextFunction.class));
