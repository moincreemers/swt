...
public class AuthenticationTypeVariable implements JsVariable {
    public static final String ID = "authenticationType";
    private final Widget widget;
    private final WidgetType widgetType;

    public AuthenticationTypeVariable(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("'%s'", hasAbstractURL.getAuthenticationType().name());
    }
}
