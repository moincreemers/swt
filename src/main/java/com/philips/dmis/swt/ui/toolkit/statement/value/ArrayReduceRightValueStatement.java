...
@Description("Executes a reducer function on each element of the array from right to left and finally returns the result")
public class ArrayReduceRightValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final ValueStatement reducer;
    private final ValueStatement initialValue;

    public ArrayReduceRightValueStatement(ValueStatement array, ValueStatement reducer) throws WidgetConfigurationException {
        this(array, reducer, null);
    }

    public ArrayReduceRightValueStatement(ValueStatement array, ValueStatement reducer, ValueStatement initialValue) throws WidgetConfigurationException {
        this.array = array;
