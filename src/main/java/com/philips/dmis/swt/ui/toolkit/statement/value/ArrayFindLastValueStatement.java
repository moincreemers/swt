...
@Description("Finds the last value using the specified predicate and returns the value")
public class ArrayFindLastValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final PredicateStatement predicate;

    public ArrayFindLastValueStatement(ValueStatement array, PredicateStatement predicate) {
        this.array = array;
