...
@Description("Returns true if every element in the array matches using the specified predicate")
public class ArrayEveryValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final PredicateStatement predicate;

    public ArrayEveryValueStatement(ValueStatement array, PredicateStatement predicate) {
        this.array = array;
