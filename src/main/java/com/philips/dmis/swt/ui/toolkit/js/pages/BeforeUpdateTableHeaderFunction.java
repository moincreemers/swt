...
public class BeforeUpdateTableHeaderFunction implements JsFunction, IsPageModuleMember {
    public static final String ID = "beforeUpdateTableHeader";
    private final Widget widget;
    private final WidgetType widgetType;

    public BeforeUpdateTableHeaderFunction(Widget widget) {
        this.widget = widget;
