...
public class PadStartValueStatement extends ValueStatement {
    private final ValueStatement value;
    private final ValueStatement maxLength;
    private final ValueStatement fillString;

    public PadStartValueStatement(ValueStatement value, ValueStatement maxLength) {
        this(value, maxLength, null);
    }

    public PadStartValueStatement(ValueStatement value, ValueStatement maxLength, ValueStatement fillString) {
        this.value = value;
