...
public class ArrayReduceValue extends ValueStatement {
    private final ValueStatement array;
    private final ValueStatement reducer;
    private final ValueStatement initialValue;

    public ArrayReduceValue(ValueStatement array, ValueStatement reducer) throws WidgetConfigurationException {
        this(array, reducer, null);
    }

    public ArrayReduceValue(ValueStatement array, ValueStatement reducer, ValueStatement initialValue) throws WidgetConfigurationException {
        this.array = array;
