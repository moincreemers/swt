...
@Description("Finds a value using the specified predicate and returns the value")
public class ArrayFindValueStatement extends ValueStatement {
    private final ValueStatement array;
    private final PredicateStatement predicate;

    public ArrayFindValueStatement(ValueStatement array, PredicateStatement predicate) {
        this.array = array;
