...
public class ContentTypeEncodingVariable implements JsVariable {
    public static final String ID = "contentTypeEncoding";
    private final Widget widget;
    private final WidgetType widgetType;

    public ContentTypeEncodingVariable(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("'%s'", hasAbstractURL.getContentType().getEncoding());
    }
}
