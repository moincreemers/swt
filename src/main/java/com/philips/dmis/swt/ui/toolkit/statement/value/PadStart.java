...
public class PadStart extends ValueStatement {
    private final ValueStatement value;
    private final ValueStatement maxLength;
    private final ValueStatement fillString;

    public PadStart(ValueStatement value, ValueStatement maxLength) {
        this(value, maxLength, null);
    }

    public PadStart(ValueStatement value, ValueStatement maxLength, ValueStatement fillString) {
        this.value = value;
