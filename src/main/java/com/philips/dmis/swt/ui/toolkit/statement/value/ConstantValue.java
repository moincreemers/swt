...
public class ConstantValue extends ValueStatement {
    ...
    public ConstantValue(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0, 0);
    }

    public ConstantValue(int year, int month, int dayOfMonth, int hour, int minute, int second, int milliSecond) {
    ...
    public ConstantValue(Object[] array) {
        this.value = array;
        this.jsType = JsType.ARRAY;
    }

    public ConstantValue(Iterable<?> iterable) {
        this.value = Arrays.asList(iterable).toArray();
        this.jsType = JsType.ARRAY;
    }

    public ConstantValue(Object value, JsType jsType) {
        this.value = value;
        this.jsType = jsType;
    }
