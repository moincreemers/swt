...
public class BeforeUpdateTextFunction implements JsFunction, IsPageModuleMember {
    public static final String ID = "beforeUpdateText";
    private final Widget widget;
    private final WidgetType widgetType;

    public BeforeUpdateTextFunction(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("%s('');", JsPagesModule.getId(widget, SetTextFunction.class));
