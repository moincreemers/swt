...
public class GridColumnsVariable implements JsVariable {
    public static final String ID = "gridColumns";
    private final Widget widget;
    private final WidgetType widgetType;

    public GridColumnsVariable(Widget widget) {
        this.widget = widget;
