...
public class ResponseTypeVariable implements JsVariable {
    public static final String ID = "responseType";
    private final Widget widget;
    private final WidgetType widgetType;

    public ResponseTypeVariable(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("'%s'", hasAbstractURL.getResponseType().getValue());
    }
}
