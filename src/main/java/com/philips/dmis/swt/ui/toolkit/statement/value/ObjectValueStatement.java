...
@Description("Returns the object builder")
public class ObjectValueStatement extends ValueStatement {
    private final Map<ValueStatement, ValueStatement> map = new LinkedHashMap<>();

    public ObjectValueStatement() {
    }

    public ObjectValueStatement add(ValueStatement property, ValueStatement value) {
