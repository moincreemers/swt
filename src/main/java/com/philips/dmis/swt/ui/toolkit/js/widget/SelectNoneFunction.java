...
public class SelectNoneFunction implements JsFunction {
    public static final String ID = "selectNone";
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("if(element.selectedIndex!=-1){");
        js.append("element.selectedIndex==-1;");
