...
public class UpdateValueFunction implements JsFunction, IsPageModuleMember {
    public static final String ID = "updateValue";
    private final Widget widget;
    private final WidgetType widgetType;

    public UpdateValueFunction(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("%s(object);", JsPagesModule.getId(widget, SetValueFunction.class));
