...
public class DateUTCValueStatement extends ValueStatement {
    ...
    public DateUTCValueStatement(ValueStatement year, ValueStatement monthIndex) {
        this(year, monthIndex, null, null, null, null, null);
    }

    public DateUTCValueStatement(ValueStatement year, ValueStatement monthIndex, ValueStatement day) {
        this(year, monthIndex, day, null, null, null, null);
    }

    public DateUTCValueStatement(ValueStatement year, ValueStatement monthIndex, ValueStatement day, ValueStatement hour) {
        this(year, monthIndex, day, hour, null, null, null);
    }

    public DateUTCValueStatement(ValueStatement year, ValueStatement monthIndex, ValueStatement day, ValueStatement hour, ValueStatement minute) {
        this(year, monthIndex, day, hour, minute, null, null);
    }

    public DateUTCValueStatement(ValueStatement year, ValueStatement monthIndex, ValueStatement day, ValueStatement hour, ValueStatement minute, ValueStatement second) {
        this(year, monthIndex, day, hour, minute, second, null);
    }

    public DateUTCValueStatement(ValueStatement year, ValueStatement monthIndex, ValueStatement day, ValueStatement hour, ValueStatement minute, ValueStatement second, ValueStatement milliSecond) {
        this.year = year;
