...
@Description("Returns true if the provided string starts with another string")
public class StartsWithValueStatement extends ValueStatement {
    private final ValueStatement left;
    private final ValueStatement right;

    public StartsWithValueStatement(ValueStatement left, ValueStatement right) {
        this.left = left;
        this.right = right;
    }
