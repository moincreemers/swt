...
public class CacheTypeVariable implements JsVariable {
    public static final String ID = "cacheType";
    private final Widget widget;
    private final WidgetType widgetType;

    public CacheTypeVariable(Widget widget) {
        this.widget = widget;
    ...
    public void renderJs(Toolkit toolkit, JsWriter js) throws JsRenderException {
        ...
        js.append("'" + dataSourceSupplier.getCacheType().name() + "'");
    }
}
