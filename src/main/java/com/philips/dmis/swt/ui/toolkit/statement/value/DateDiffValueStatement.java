...
@Description("Returns the difference between two dates expressed in the specified interval")
public class DateDiffValueStatement extends ValueStatement {
    private final ValueStatement date0;
    private final ValueStatement date1;
    private final TimeIntervalType timeIntervalType;

    public DateDiffValueStatement(ValueStatement date0, ValueStatement date1, TimeIntervalType timeIntervalType) {
        this.date0 = date0;
        this.date1 = date1;
