...
@Component
public class DialogBottomLeftExample extends Page {
    public DialogBottomLeftExample() throws Exception {
        super(ViewType.DIALOG, ViewPosition.DIALOG_BOTTOM_LEFT);
    }

    @Override
    protected void build() throws Exception {
        Panel headingPanel = add(new Panel(PanelType.PADDED));
