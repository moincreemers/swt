...
public class JsGlobalModule implements JsModule {
    ...
    private static final List<JsMember> MEMBERS = Arrays.asList(
            ...
            new CreatePromiseFunction(),
            new CreateUniqueKeyFunction(),
